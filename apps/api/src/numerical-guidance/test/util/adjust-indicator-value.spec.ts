...
describe('AdjustIndicatorValue(extends IndicatorValueManager)', () => {
  it('Day interval 에 따른 indicatorValue 변환', async () => {
    ...
    // console.log(mockHistoryIndicatorValues);
    // const mockValues: any[] = mockHistoryIndicatorValues.values;
    //
    // const historyIndicatorValues: IndicatorValue[] = mockValues?.map((value) => {
    //   return {
    //     date: value.datetime,
    //     value: value.close,
    //   };
